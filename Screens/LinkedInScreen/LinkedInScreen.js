    ...
    >
      ...
      <View style={styles.container}>
        ...
        <View style={styles.field}>
          <TextInput style={styles.input} cursorColor={'blueviolet'} selectionColor={'blueviolet'} value={linkedIn} onChangeText={setLinkedIn} placeholder='e.g https://www.google.com' />
