    ...
    >
      ...
      <View style={styles.container}>
        ...
        <View style={styles.field}>
          <TextInput style={styles.input} cursorColor={'blueviolet'} selectionColor={'blueviolet'} value={youtubeLink} onChangeText={setYoutubeLink} placeholder='e.g https://www.google.com' />
