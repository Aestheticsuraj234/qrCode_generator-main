    ...
    >
      ...
      <View style={styles.container}>
        ...
        <View style={styles.field}>
          <TextInput style={styles.input} cursorColor={'blueviolet'} selectionColor={'blueviolet'} value={musicLink} onChangeText={setMusicLink} placeholder='e.g https://play.google.com/store/apps/details?id=com.facebook.katana&hl=en_IN&gl=US' />
