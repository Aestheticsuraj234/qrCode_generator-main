    ...
    >
      ...
      <View style={styles.container}>
        ...
        <View style={styles.field}>
          <TextInput style={styles.input} cursorColor={'blueviolet'} selectionColor={'blueviolet'} value={whatsAppLink} onChangeText={setWhatsAppLink} placeholder='e.g https://www.google.com' />
