...
export default function FacebookScreen() {
  ...
  const { saveQRCode, QR, setInput, setQRref, setQR ,facebookLink,setFacebookLink,generateFbQRCode} = useContext(QrCodeContext)
    ...
    >
      ...
      <View style={styles.container}>
        ...
        <View style={styles.field}>
          <TextInput style={styles.input} cursorColor={'blueviolet'} selectionColor={'blueviolet'} value={facebookLink} onChangeText={setFacebookLink} placeholder='e.g https://www.google.com' />
